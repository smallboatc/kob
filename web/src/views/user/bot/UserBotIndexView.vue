...
export default {
  ...
  setup() {
    ...
    const refresh_bots = () => {
      $.ajax({
        url: "https://smallboat.games/api/user/bot/getList/",
        type: "get",
        headers: {
    ...
    const add_bot = () => {
      ...
      $.ajax({
        url: "https://smallboat.games/api/user/bot/add/",
        type: "post",
        data: {
          title: botAdd.title,
    ...
    const update_bot = (bot) => {
      ...
      $.ajax({
        url: "https://smallboat.games/api/user/bot/update/",
        type: "post",
        data: {
          botId: bot.id,
          title: bot.title,
    ...
    const remove_bot = (bot) => {
      $.ajax({
        url: "https://smallboat.games/api/user/bot/delete/",
        type: "post",
        data: {
          botId: bot.id,
        },
